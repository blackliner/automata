...
public:
    ...
    double GetGunAngle() const { return gun_angle; }
    double GetGunRange() const { return gun_range; }
    bool GetGunShot() const { return gun_shot; }
    Vector2D<VectorT> GetPos() const { return gun_shell_pos; }
    double GetShellRadius() const { return gun_shell_radius; }
};
